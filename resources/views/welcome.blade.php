            ...
            <div class="col-lg-6 mb-30">
                ...
                <ul class="list-checked list-checked--team">
                    <li>
                        ...
                        <span class="text-sm neutral-500">{{ __('Backend, frontend, mobile, DevOps и QA — собирают клиентский цифровой банк, личные кабинеты, API‑шлюз к ОИС НЕКСУС и технологический слой ГАНИМЕД в единую управляемую среду, где каждое распоряжение инвестора или инициатора проходит предсказуемый маршрут от интерфейса до реестра.') }}</span>
                    </li>
                    <li>
                        <span class="d-block fw-semibold neutral-0 mb-5">{{ __('Методологи проектного цикла') }}</span>
                        <span class="text-sm neutral-500">{{ __('Описывают, как проект проходит путь от заявки инициатора до выпуска ЦФА, размещения, контроля траншей и выплат: структуры финансирования, KPI, ковенанты и регламенты, которые затем становятся правилами ОИС и сценариями в цифровом банке.') }}</span>
                    </li>
                    <li>
                        <span class="d-block fw-semibold neutral-0 mb-5">{{ __('Аналитика и риск‑менеджмент') }}</span>
                    ...
                    <li>
                        <span class="d-block fw-semibold neutral-0 mb-5">{{ __('Комплаенс и правовой блок') }}</span>
                    ...
                    <li>
                        <span class="d-block fw-semibold neutral-0 mb-5">{{ __('Скоринг, ML и оптимизация (НЕКСУС ИИ)') }}</span>
                        <span class="text-sm neutral-500">{{ __('Модели предварительного скоринга проектов, подбора инструментов для инвестора и раннего выявления аномалий: в цифровом банке — понятные рекомендации и объяснения, в ОИС — контроль параметров допуска и мониторинг обязательств без подмены юридического решения алгоритмом.') }}</span>
                    </li>
                </ul>
            </div>
            <div class="col-lg-6 mb-30">
