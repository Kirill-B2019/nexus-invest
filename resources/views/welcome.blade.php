        ...
        <div class="row">
            <div class="col-lg-6 mb-30">
                <div class="testimonial-img-animated">
                    <img src="{{ asset('assets/imgs/page/homepage1/img-testimonial.png') }}" alt="{{ config('app.name') }}" loading="lazy" decoding="async" class="w-70 justify-center">
                </div>
                <ul class="list-checked list-checked--team">
                    ...
                    <li>
                        <span class="d-block fw-semibold neutral-0 mb-5">{{ __('Операторы скоринга, ML и оптимизации (НЕКСУС ИИ)') }}</span>
                        <span class="text-sm neutral-500">{{ __('Обучают и разрабатываь модели предварительного скоринга проектов, подбора инструментов для инвестора и раннего выявления аномалий, контроль параметров допуска и мониторинг обязательств без подмены юридического решения алгоритмом.') }}</span>
                    </li>
                </ul>
            </div>
            <div class="col-lg-6 mb-30">
