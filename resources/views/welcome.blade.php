                ...
                <div class="row align-items-start">
                    <div class="col-12 col-lg-6 order-1 order-lg-1">
                        <div class="box-banner-left">
                                ...
                                <p class="neutral-300 small pt-3 uppercase">{{ __('Новационная Единая ') }} <span class="neutral-100 display-6 uppercase"> {{ __('Комплексная Система Управления ') }} </span>{{ __('Сделками') }}</p>
