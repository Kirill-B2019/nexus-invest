...
{{ __('Документация НЕКСУС: условия использования платформы, политика конфиденциальности, пользовательское соглашение, правила токенизации и инвестирования.') }}
@endsection

@section('metaKeywords')
{{ __('документация НЕКСУС, условия использования, политика конфиденциальности, пользовательское соглашение, правила платформы') }}
@endsection
        ...
        <div class="row">
            <div class="col-12 col-md-8 col-lg-9 order-2 order-lg-1">
                ...
                <x-guest.documentation-list-card
                    ...
                    :links="[
                        ['href' => 'https://scan.gnd-net.com', 'label' => __('сканер блокчейна ГАНИМЕД')],
                        ['href' => 'https://main-node.gnd-net.com', 'label' => __('ГАНИМЕД API v1.0 (REST API, WebSocket API, RPC API)')],
                    ]"
                />
                <hr>
                <x-guest.documentation-list-card
                    ...
                    :links="[
                        ['href' => asset('doc/NexusRegtech.pdf'), 'label' => __('REGTECH в экосистеме концепция, прикладная архитектура')],
                        ['href' => asset('doc/LegalStatusRussianFederationGndGaniValidator.pdf'), 'label' => __('Правовой статус и применимость в российской федерации gnd и gani статус валидаторов и вознаграждение за техническую деятельность')],
