    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-lg-8 text-center">
                <img class="wow fadeInUp w-100" src="{{ asset('assets/imgs/page/homepage1/arch-image.png') }}" alt="{{ __('Архитектура экосистемы НЕКСУС и блокчейна ГАНИМЕД') }}" loading="lazy" decoding="async">
...
<section class="section-box wow animate__animated animate__fadeIn box-how-it-work animated box-pricing-2" style="visibility: visible;">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-lg-8 text-center">
                <img class="wow fadeInUp w-50" src="{{ asset('assets/imgs/page/homepage1/map-rf.png') }}" alt="{{ __('Интерактивная карта инвестиционных проектов России') }}" loading="lazy" decoding="async">
            </div>
            <div class="col-12 col-lg-4">
                <div class="box-border-rounded">
                    <div class="card-casestudy">
