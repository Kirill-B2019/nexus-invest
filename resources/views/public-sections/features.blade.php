...
{{-- Архитектура экосистемы НЕКСУС / ГАНИМЕД — масштабируемый рисунок по ширине контейнера --}}
<section class="section-box wow animate__animated animate__fadeIn box-how-it-work animated box-pricing-2" id="ecosystem-architecture" style="visibility: visible;">
    <div class="container">
        <a class="btn btn-brand-4-sm" href="#">{{__('Как это все работает?')}}</a>
            <h2 class="mt-15 mb-20">{{ __('Архитектура экосистемы НЕКСУС / ГАНИМЕД') }}</h2>
            ...
            <div class="col-12 col-lg-4">
                <div class="box-border-rounded">
                    <div class="card-casestudy">
                        <div class="card-title">
                            <h5>{{__('Экосистема строится вокруг блокчейна ГАНИМЕД')}}</h5>
                        </div>
                        <div class="card-desc">
                            <h6 class="mb-2">{{__('Юрисдикция РФ')}}</h6>
                            <p>{{__('- ОИС НЕКСУС')}}</p>
                            <p>{{__('- Регуляторный комплаенс (ЦБ, ФНС)')}}</p>
                            <p>{{__('- Валидаторы PoA РФ')}}</p>
                            <p>{{__('- НЕКСУС‑ДЕПО (цифровой депозитарий)')}}</p>
                            <p>{{__('- Маркетплейс цифровых активов')}}</p>
                            <p>{{__('- Инвесторы РФ и Эмитенты')}}</p>
                            <p>{{__('- GANI - технические токены протокола блокчейна')}}</p>
                            <h6 class="mb-2">{{__('Мульти-юрисдикция')}}</h6>
                            <p>{{__('- СФОРДЕКС')}}</p>
                            <p>{{__('- Валидаторы PoS')}}</p>
                            <p>{{__('- НЕКСУС‑ДЕПО (цифровой депозитарий)')}}</p>
                            <p>{{__('- Маркетплейс цифровых активов')}}</p>
                            <p>{{__('- Инвесторы РФ и Эмитенты')}}</p>
                            <p>{{__('- Биржевой оборот GND и GANI, проектные деривативы')}}</p>
                            <p class="m-2 small uppercase neutral-800">{{__('ГАНИМЕД обеспечивает единый реестр и криптографический шлюз ГОСТ 34.12‑2015 / AES, сохраняя юридическую значимость учёта в РФ и открывая регулируемый доступ к международной ликвидности.')}}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box-border-rounded">
                    <div class="card-casestudy">
                        ...
                        <div class="card-desc">
                            ...
                            <p class="mb-0"><a href="{{ route('nexus-ai') }}">{{ __('Подробнее о НЕКСУС ИИ') }}</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12 col-lg-4">
                <div class="box-border-rounded">
                    <div class="card-casestudy">
                        <div class="card-title">
                            <h6><span class="number">5</span>{{__('НЕКСУС ИИ на витрине')}}</h6>
                        </div>
                        <div class="card-desc">
                            <p>{{__('Подборки и рекомендации по профилю инвестора строятся на контуре НЕКСУС ИИ — едином сервисе скоринга, стратегий и аналитики экосистемы.')}}</p>
                            <p class="mb-0"><a href="{{ route('nexus-ai') }}">{{ __('Подробнее о НЕКСУС ИИ') }}</a></p>
                        </div>
                    </div>
                </div>
