...
{{ __('Соответствие НЕКСУС законодательству РФ: 259-ФЗ о ЦФА, 289-ФЗ о платформенной экономике, 39-ФЗ, 187-ФЗ, 115-ФЗ о ПОД/ФТ, 152-ФЗ о персональных данных.') }}
@endsection

@section('metaKeywords')
{{ __('соответствие законодательству, 259-ФЗ, 289-ФЗ, ЦФА, нормативы, ПОД/ФТ, 152-ФЗ, НЕКСУС, регуляторика') }}
@endsection
