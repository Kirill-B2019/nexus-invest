...
{{ __('ГАНИМЕД — гибридный блокчейн с ГОСТ-криптографией для токенизации RWA. GNDst-1, PoSA, KYC из коробки. Инфраструктура экосистемы НЕКСУС.') }}
@endsection
            ...
            <div class="col-lg-4 col-sm-6">
                <div class="card-features-5">
                    ...
                    <div class="card-info">
                        ...
                        <p class="text-sm neutral-500 mt-10 mb-0"><a href="{{ route('nexus-ai') }}">{{ __('См. также НЕКСУС ИИ — мозг экосистемы') }}</a></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6">
        ...
        <div class="row mt-90">
            <div class="col-12 col-md-4">
                <div class="card-preparing-3">
                   ...
                   <p class="text-start">{{ __('- 1 500–5 000 TPS') }}</p>
            ...
            <div class="col-12 col-md-4">
                <div class="card-preparing-3">
                    ...
                    <div class="card-info">
                        ...
                        <p class="text-start">{{ __('- 34.12-2015 (Кузнечик/Магма)') }}</p>
...
<section class="section-box wow fadeIn" id="ignd-steps">
    <div class="container">
        <div class="text-center mb-60">
            ...
            <p class="text-lg neutral-600">{{ __('Внедрение ГАНИМЕД в рамках экосистемы НЕКСУС') }}</p>
        </div>
        <div class="ignd-steps-list">
            <x-guest.ignd-step
                ...
                :title="__('ВЫПОЛНЕНО')"
                :paragraphs="[
                    __('запуск MVP блокчейна ГАНИМЕД, тестирование нагрузки, запуск API и сканера, деплой базовой библиотеки контрактов, начальная и циркулирующая эмиссия GND и GANI'),
                ]"
            />
            <x-guest.ignd-step
                :number="2"
            ...
            <x-guest.ignd-step
                ...
                :paragraphs="[
                    ...
                    __('нагрузочные тесты 1500 TPS; ГОСТ-интеграция.'),
