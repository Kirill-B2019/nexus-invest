                            ...
                            <tr>
                                ...
                                <td class="actions-cell">
                                    <div class="table-actions-desktop d-none d-md-block">
                                        <a href="{{ route('lk.admin.settings.dictionaries.item.edit', [$dictionary, $item]) }}" class="btn btn-outline-primary btn-sm mr-1">{{ __('Изменить') }}</a>
                                        <form method="post" action="{{ route('lk.admin.settings.dictionaries.item.destroy', [$dictionary, $item]) }}" class="d-inline" onsubmit="return confirm('{{ __('Удалить элемент?') }}');">
                                            @csrf
                                            @method('DELETE')
                                    ...
                                    <div class="table-actions-mobile d-md-none dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="{{ route('lk.admin.settings.dictionaries.item.edit', [$dictionary, $item]) }}">{{ __('Изменить') }}</a>
                                            <form method="post" action="{{ route('lk.admin.settings.dictionaries.item.destroy', [$dictionary, $item]) }}" class="dropdown-item p-0" onsubmit="return confirm('{{ __('Удалить элемент?') }}');">
                                                @csrf
                                                @method('DELETE')
