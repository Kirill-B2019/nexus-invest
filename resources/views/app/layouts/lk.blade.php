{{--
  Внутренняя часть (ЛК). Источник: resources/src/app/src/Dashboard.Default.html.
  Подключены все CSS и JS из шаблона. Ресурсы: public/app/ (asset('app/...')).
  Тема: scripts.js + window.DORE_BASE.
--}}
<!DOCTYPE html>
...
<head>
    ...
    <style>
        /* Скрыть выбор тем в боковом меню (панель с волшебной палочкой) */
        #app-container .theme-colors,
        #app-container .theme-button { display: none !important; }
        /* Убрать логотип Dore везде (темы задают background на .logo / .logo-mobile) */
        ...
        /* Логотипы: светлая тема — logo-black.svg, тёмная — white-full.svg (Bootstrap d-none/d-block сохраняется) */
