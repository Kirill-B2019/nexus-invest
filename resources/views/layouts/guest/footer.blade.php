                ...
                <div class="row">
                    <div class="col-12 col-sm-6 mb-30">
                        ...
                        <ul class="menu-footer text-sm">
                            ...
                            <li><a href="{{ asset('doc/NEXUS-KYCAMLPolicy-17022026.pdf') }}" target="_blank" rel="noopener noreferrer">{{ __('KYC/AML‑политика НЕКСУС') }}</a></li>
                        </ul>
                    </div>
                    <div class="col-12 col-sm-6 mb-30">
            ...
            <div class="row align-items-start mb-20">
                ...
                <div class="col-12 col-md-6 mb-20 mb-md-0 text-center text-md-start">
                    <div  class="alert alert-footer">
                        ...
                        <p class="neutral-600 mb-0 small">{{ __('GND, GANI, iGND  — технические токены протокола блокчейна ГАНИМЕД, используемые исключительно для обеспечения работы блокчейн‑инфраструктуры. Они не подлежат прямой продаже, покупке или иному обороту резидентам Российской Федерации в соответствии с российским законодательством (ФЗ‑259 «О цифровых финансовых активах»).') }}</p>
                ...
                <div class="col-12 col-md-9 mb-15 mb-md-0 text-center text-sm-start">
                    ...
                    <p class="neutral-600 mb-0 small">
                        {{ __('ГАНИМЕД предоставляет технологическую инфраструктуру, которую
                              будет использовать российский оператор ЦФА и оператор обмена ЦФА — проектная
                              инвестиционная платформа «НЕКСУС» (после регистрации в качестве ОИС), действующая в соответствии с
                              требованиями Банка России (ФЗ-259, ст. 3, 5; нормативные акты Банка России
                              об операторах ИС и операторах обмена ЦФА).') }}
                    </p>
                    <p class="neutral-600 mb-0 small">
                        {{ __('Информационная система блокчейна ГАНИМЕД является децентрализованной
                               и мультиюрисдикционной технологической сетью. Как открытая
                               децентрализованная сеть, ГАНИМЕД не является оператором информационной
                               системы выпуска ЦФА в смысле Федерального закона от 31.07.2020 № 259-ФЗ
                               «О цифровых финансовых активах, цифровой валюте…» и самостоятельно не
                               осуществляет выпуск ЦФА в рамках правового режима указанного Закона.
                               Под «оператором информационной системы выпуска ЦФА» в смысле ФЗ-259
                               (ст. 3, 5) понимается российское юридическое лицо, включённое Банком
                               России в специальный реестр, в информационной системе которого
