            ...
            <div class="row align-items-start mb-20">
                <div class="col-12 col-md-6 mb-20 mb-md-0 text-center text-md-start">
                    <div  class="alert alert-footer">
                        ...
                        <p class="neutral-600 mb-0 small">{{ __('Проектные утилити токены (GND-RWA): Утилитарные цифровые права (УЦП) и учетные токены без денежных прав/доходности. Право на услуги, участие в проектах RWA (токенизация активов) или информацию.') }}</p>
                    </div>
                </div>
