...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('app/css/app.css') }}?v=1.0.2">
    {{-- Опциональные стили виджетов Dore (календарь, DataTables, Select2 и т.д.): @push('vendor-styles') @include('layouts.app.partials.lk-vendor-css-optional') @endpush --}}
    @stack('vendor-styles')
    @stack('styles')
</head>
<body id="app-container" class="menu-default{{ $isDarkTheme ? ' theme-dark' : ' theme-light' }}" data-lk-theme="{{ $isDarkTheme ? 'dark' : 'light' }}">
