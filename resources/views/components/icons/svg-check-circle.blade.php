@php
    static $checkId = 0;
    $checkId++;
    $clipId = 'clip-check-' . $checkId;
@endphp
<svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none" {{ $attributes }}>
    ...
    <defs>
        <clipPath id="{{ $clipId }}"><rect width="26" height="26" fill="white"></rect></clipPath>
    </defs>
</svg>
