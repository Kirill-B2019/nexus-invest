...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Support (ЛК: ссылка «Поддержка» в топбаре — mailto:)
    |--------------------------------------------------------------------------
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Очередь исходящих писем (OutboundMailService)
    |--------------------------------------------------------------------------
    |
    | false — отправка сразу (рекомендуется на shared-хостинге без queue:work).
    | true  — Mail::queue(), нужен работающий воркер очереди.
    |
    */
    'queue_outbound' => env('MAIL_QUEUE_OUTBOUND', false),
